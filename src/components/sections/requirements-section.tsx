      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-4 mb-16">
          <h2 className="text-xl sm:text-2xl font-bold">
            <span className="text-gradient">Simple Setup</span>, Powerful
            Features
          </h2>
          <p className="text-muted-foreground max-w-3xl mx-auto">
            Get started in minutes with minimal requirements. Everything you
            need to bring Spotify control to your development workflow.
          </p>
        </div>
            ...
            <div className="bg-green-500/5 border border-green-500/20 rounded-lg p-6">
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Most users are up and running in under 2 minutes. The
                    extension handles all the complex Spotify API integration
                    for you.
                  </p>
                </div>
              </div>
